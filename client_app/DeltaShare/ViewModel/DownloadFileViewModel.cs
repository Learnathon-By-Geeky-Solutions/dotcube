...
namespace DeltaShare.ViewModel
{
    public partial class DownloadFileViewModel(PoolUserClientService clientService) : BaseViewModel
    {
        ...
        private void ClickRefreshBtn()
        {
            ...
            //    new("uuid3", 3000, "file3 asldfk asd fadf asdf asdfasd f", "1.1.1.3", "video/mp4", "/some/path3") {
            //        IsDownloading = true,
            //        DownloadedSize = 1000,
            //        Size = 2000
            //    },
            //    new("uuid4", 4000, "file4", "1.1.1.4", "video/mp4", "/some/path4"),
            //    new("uuid5", 5000, "file5a sdlf adj falsdjf alksdjfas df", "1.1.1.5", "video/mp4", "/some/path5") {
            //        IsDownloading = true,
            //        DownloadedSize = 2000,
            //        Size = 5000,
            //    },
